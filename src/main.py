...
from color import BASE_COLOR_TERMINAL, RED_TERMINAL, PURPLE_TERMINAL


def getDefaultHost():
    strDefaultHost = input(
        """\nИграть на разных устройствах в локальной сети? ({:s}y{:s} or {:s}N{:s}): """  # noqa: E501
...
def main():
    ...
    window = Window(WINDOW_WIDTH, WINDOW_HEIGHT,
                    CANVAS_WIDTH, CANVAS_HEIGHT, node)
    window.run()
