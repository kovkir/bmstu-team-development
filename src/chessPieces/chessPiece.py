...
from color import WHITE_CHESS_PIECE, WHITE_CHESS_PIECE_BOERDER, \
    BLACK_CHESS_PIECE_BOERDER
...
class ChessPiece:
    ...
    def __init__(self, canvas: Canvas,
        ...
        self.name = name
        self.color = color
        self.colorBorder = WHITE_CHESS_PIECE_BOERDER if \
            color == WHITE_CHESS_PIECE else BLACK_CHESS_PIECE_BOERDER
        self.xCell = xCell
        self.yCell = yCell
    ...
    def calculateMovement(self, mainWhiteСolor: bool, isColorWhite: bool,
        ...
        print("Попытка нахождение списка всех" +
              " возможных ходов несуществующей фигуры")
